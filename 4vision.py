...
def main():
    ...
    url = "https://www.4dvision.be/category/vacatures/"
    ...
    proftext_divs = soup.find_all("div", class_="proftext")
    ...
    worksheet.update_cell(1, 1, 'https://www.4dvision.be/')
    for i, job in enumerate(job_list, start=1):
        worksheet.update_cell(1, i + 1, job)
    ...
    worksheet.update_cell(1, len(job_list) + 2, current_date)
    worksheet.update_cell(1, len(job_list) + 3, current_time)
